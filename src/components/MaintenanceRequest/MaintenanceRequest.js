        ...
        <div>
            ...
            <form onSubmit={onSubmit}>
                ...
                <Input max='50' min='0' type='number' onChange={onInputChange} value={num_requests}
                       ...
                       className='mb-1'/>
                <Input required onChange={onInputChange} value={address} name='address' label='Address' className='mb-1'/>
                <Input required onChange={onInputChange} value={city} name='city' label='City' className='mb-1'/>
                <Input required onChange={onInputChange} value={zip_code} name='zip_code' label='Zip Code' className='mb-1'/>
